...
let outputDirBtn, statusText, processingIndicator, outputFormat;
let lastOutputDir = '';
...
function renderFileList() {
  if (files.length === 0) {
    fileList.innerHTML = '<div class="empty-state">No files added. Drag images here, or click browse.</div>';
    return;
  }
  fileList.innerHTML = '';
